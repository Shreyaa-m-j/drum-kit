...
function playSound(buttominnerHTML) {
...
function animate(buttonChoosed){
    document.querySelector("."+buttonChoosed).classList.add("pressed");

    setTimeout(function(){
        document.querySelector("."+buttonChoosed).classList.remove("pressed");
    },100);
}